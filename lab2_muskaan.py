...
perimeter = (rectangular_width + rectangular_length) * 2 # Modify it to calculate perimeter
...
def first_even_natural_nums(total):
  ...
  while count < total:
    ...
    x = x + 2
    count = count + 1
    print(f"The excercise 8's function call can be: ")
    first_even_natural_nums(4)
